...
public interface GrupoControllerOpenApi {
	...
	GrupoModel alterar(@ApiParam(value = "ID de um grupo", example = "1", required = true) 
						Long codigo, 
	...
	void remover(@ApiParam(value = "ID de um grupo", example = "1", required = true) Long codigo);
