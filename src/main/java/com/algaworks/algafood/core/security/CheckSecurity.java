...
public @interface CheckSecurity {
	...
	public @interface Pedidos {
	    ...
	    @PostAuthorize("hasAuthority('CONSULTAR_PEDIDOS') or "
	    		+ "@algaSecurity.usuarioAutenticadoIgual(returnObject.cliente.id) or "//variável implicita para obter o objeto de retorno do objeto, no caso a instancia do pedidoModel no controller
