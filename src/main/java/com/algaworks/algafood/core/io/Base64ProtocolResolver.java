...
public class Base64ProtocolResolver implements ProtocolResolver, ApplicationContextInitializer<ConfigurableApplicationContext> {
	...
	//Assim que a aplicação inicializar vai diparar um evento que este listener estará escutando
	/*@Override
	public void onApplicationEvent(ApplicationContextInitializedEvent event) {
		event.getApplicationContext().addProtocolResolver(this); //adiciona o protocolo no context do spring ao ser iniciado
	}
	*/
}
